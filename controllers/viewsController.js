...
exports.getCreateTourForm = (req, res) => {
  res.status(200).render('create-new-tour', {
    title: 'Create new Tour'
  });
};

exports.getUpdateTourForm = (req, res) => {
  res.status(200).render('update-tour', {
    title: 'Update Tour'
  });
};

exports.getDeleteTourForm = (req, res) => {
  res.status(200).render('delete-tour', {
    title: 'Delete Tour'
  });
};
...
exports.getManageReviews = (req, res) => {
